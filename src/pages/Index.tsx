          ...
          <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-muted-foreground">sales@medpharm.com</div>
                    <div className="text-muted-foreground">support@medpharm.com</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-muted-foreground">123 Pharma Avenue</div>
                    <div className="text-muted-foreground">Medical District, NY 10001</div>
                  </div>
                </div>
              </div>
            </div>
            <div className="glass p-8 rounded-2xl border border-primary/30">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label className="text-sm font-medium mb-2 block">Company/Hospital</label>
                  <Input
